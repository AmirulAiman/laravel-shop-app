...
<body
    class="bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans min-h-screen flex flex-col transition-colors duration-200">
    ...
    <main class="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="text-center max-w-3xl mx-auto mb-16">
            <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                ...
                <span
                    class="block text-indigo-600 dark:text-indigo-400 mt-2">{{ __('Find Your Perfect Products') }}</span>
            </h1>
        ...
        <div>
            <h2
                class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white mb-8 border-b border-gray-200 dark:border-gray-700 pb-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                @forelse ($products as $product)
                    <div
                        class="flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md hover:-translate-y-1 border border-gray-100 dark:border-gray-700 overflow-hidden transition-all duration-300">
                        <!-- Product Image -->
                        <div class="aspect-square w-full relative overflow-hidden bg-gray-50 dark:bg-gray-900 group">
                            ...
                            @if ($product->stock === 0)
                                <div class="absolute inset-0 bg-black/40 flex items-center justify-center">
                                    <span
                                        class="px-3 py-1 bg-red-600 text-white text-xs font-bold uppercase rounded-md tracking-wider shadow">
                                        {{ __('Sold Out') }}
                                    </span>
                                </div>
                            @endif
                        ...
                        <div class="p-5 flex-1 flex flex-col">
                            ...
                            <div class="mb-2">
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-800/50">
                            ...
                            <div
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                        @if ($product->stock > 0)
                                            <span
                                                class="text-green-600 dark:text-green-400 font-semibold">{{ $product->stock }}
                                                {{ __('in stock') }}</span>
                                        @else
                ...
                @empty
                    <div class="col-span-full py-20 text-center">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            {{ __('Check back later for new arrivals.') }}</p>
                    </div>
                @endforelse
            </div>
        </div>
